/*=============================================
 HAIRLOUNGE MEN'S SALON – LUXURY SCRIPT
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loader) {
    window.addEventListener('load', () => {
      setTimeout(() => { loader.classList.add('hidden'); document.body.style.overflow = ''; }, 600);
    });
  ...
  function setLanguage(lang) {
    ...
    localStorage.setItem('hairlounge-lang', lang);
  ...
  const savedLang = localStorage.getItem('hairlounge-lang') || 'en';
